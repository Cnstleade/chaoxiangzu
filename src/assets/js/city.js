...
for (var i = 0;i<ARRAll.length;i++){
    ARRAll[i].value = ARRAll[i].label;
    if(ARRAll[i].children&&ARRAll[i].children.length>0){
        for(var j = 0;j<ARRAll[i].children.length;j++){
            ARRAll[i].children[j].value = ARRAll[i].children[j].label;
            if(ARRAll[i].children[j].children&&ARRAll[i].children[j].children.length>0){
                for(var h = 0;h<ARRAll[i].children[j].children.length;h++){
                    ARRAll[i].children[j].children[h].value =  ARRAll[i].children[j].children[h].label;
                }
            }
        }
    }
