            ...
            <el-table-column type="expand" label="更多详情" width="80" >
              ...
              append-to-body>
                ...
                <el-table
                  ...
                  style="width: 100%"
                  >
                      <el-table-column prop="gx" label="关系" align="center" width="100">
                          <template  slot-scope="scope">
                                  <el-tag
                      ...
                      <el-table-column prop="xm" label="姓名" align="center" width="140"></el-table-column>
                      <el-table-column prop="lxdh" label="联系电话" align="center" width="140"></el-table-column>
                      <el-table-column prop="sfz" label="身份证" align="center" width="180"></el-table-column>
                      <el-table-column prop="xb" label="性别" align="center" width="140">
                          <template  slot-scope="scope">
                                  <el-tag
                                            :type="scope.row.yk?'success':'danger'"
                ...
                <el-table-column prop="cz"  align="center" label="操作"  width="" >
                    <template slot-scope="scope">
                    <el-button
                        size="mini"
                        type="success"
